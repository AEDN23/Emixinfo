...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">PT. ELASTOMIX INDONESIA - SUPPORT DOCUMENT</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<?php if ($_SESSION['role'] == 'admin'): ?>
							<a href="stdtambah.php" class="btn btn-success">Tambah</a>
						<?php endif; ?>
					</div>
					<div class="panel-body">
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								<?php
								$i = 1;
								$sql = "SELECT * FROM std ORDER BY id_dokumen ASC";
								...
								while ($data = mysqli_fetch_array($ress)) {
									...
									echo '<td class="text-center"> <a href="stdview.php?id_dokumen=' . $data['id_dokumen'] . '" class="btn btn-primary btn-xs">Detail</a>';
									...
									echo '<a href="stdvideo.php?video=' . urlencode($data['video']) . '" target="_blank" class="btn btn-warning btn-xs">Lihat Video</a>';
...
<script>
	...
	$('[data-load-code]').on('click', function(e) {
		...
		if (code) {
			$($this.data('remote-target')).load('stdview.php?code=' + code);
			app.code = code;
