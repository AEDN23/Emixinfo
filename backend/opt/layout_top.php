...
<head>
	...
	<title>Elastomix Chart - <?php echo $pagedesc ?></title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<?php
							if(isset($menuparent) && $menuparent == "grade") {
								echo '<li class="active">';
							}
							else {
								echo '<li>';
						...
						<a href="#"><i class="fa fa-download fa-fw"></i>&nbsp;Chart Data<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Mixer Chart A-Line") {
										echo '<li><a href="grade.php" class="active">Mixer Chart A-Line</a></li>';
									}
									else {
										echo '<li><a href="grade.php">Mixer Chart A-Line</a></li>';
									}
									if($pagedesc == "Approved") {
										echo '<li><a href="gradeb.php" class="active">Kneader Chart B-Line</a></li>';
									}
									else {
										echo '<li><a href="gradeb.php">Kneader Chart B-Line</a></li>';
									}
