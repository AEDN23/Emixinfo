            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<?php
							if($pagedesc == "Beranda") {
								echo '<li><a href="" class="active"><i class="fa fa-home fa-fw"></i>&nbsp;Beranda</a></li>';
							}
							else {
								echo '<li><a href=""><i class="fa fa-home fa-fw"></i>&nbsp;Beranda</a></li>';
							}
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-folder fa-fw"></i>&nbsp;Grade Chart Data<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Grade") {
										echo '<li><a href="" class="active">Grade Chart</a></li>';
									}
									else {
										echo '<li><a href="">Grade Chart</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
