            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<a href="#"><i class="fa fa-download fa-fw"></i>&nbsp;DATA TREE INFORMASI<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Tech.QAQC") {
										echo '<li><a href="infoqc.php" class="active">Tech. QAQC</a></li>';
									}
									else {
										echo '<li><a href="infoqc.php">Tech. QAQC Info</a></li>';
									}
									if($pagedesc == "PRODUCTION") {
										echo '<li><a href="production.php" class="active">Production</a></li>';
												'<li><a href="wiproduction.php" class=active>Work Instruction</a></li>';
									}
									else {
										echo '<li><a href="production.php">Production</a></li>';
									}
