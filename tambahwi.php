...
$sql_last = "SELECT id_dokumen FROM wi ORDER BY id_dokumen DESC LIMIT 1";
...
if (mysqli_num_rows($res_last) > 0) {
	...
	$new_id = "WI-" . sprintf("%03d", $new_number);
} else {
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="id_dokumen" class="form-control" value="<?php echo $new_id; ?>" readonly>
